      ...
      <div className="order-2 lg:order-1">
        ...
        >
          <button
            ...
            className="bg-gradient-to-r from-orange-500 to-rose-500 hover:scale-105 active:scale-95 transition-all text-white font-bold py-3 px-8 rounded-full shadow-lg shadow-orange-500/20 flex items-center gap-2"
          >
